...
Car::Car(int *i,int *o){
    ...
    this->unlock_control = i[0];
    this->lock_control = i[1];
    this->light_control = i[2];
    this->horn_control = i[3];
    this->door_control = i[4];
    this->ignition_control = i[5];
    
    this->unlock_check = o[0];
    this->lock_check = o[1];
    this->door_check = o[2];
    this->ignition_check = o[3];
}
